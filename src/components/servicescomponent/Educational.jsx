      ...
      <section className="d-flex justify-content-center mb-5 servicepadding servicewidth">
        <div className="col-10 row">
          ...
          <div className="col-9" style={{ boxShadow: "1px 2px 9px black" }}>
            <div className="pt-3 px-5 mx-5 mt-5 servicepadding">
            ...
            <div className="d-flex justify-content-center pt-2 servicepadding">
              <img
            ...
            <p className=" d-flex text-center mx-5 px-5 mt-5 servicepadding">
            ...
            <div className="d-flex justify-content-center py-3 servicepadding">
              <img
            ...
            <h5 className="d-flex text-center mx-5 px-5 pt-3 servicepadding">
